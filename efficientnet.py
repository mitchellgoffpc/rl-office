# Source: https://github.com/tinygrad/tinygrad/blob/master/models/efficientnet.py
...
class EfficientNet:
  ...
  def load_from_pretrained(self):
    ...
    for k,v in b0.items():
      if k.startswith("_fc") and self._fc is None: continue
...
if __name__ == "__main__":
  model = EfficientNet(0, has_fc_output=False)
